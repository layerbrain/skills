...
| `enabling-https` | Enable browser-valid HTTPS on a machine IPv6 address with Let's Encrypt IP SAN certificates, Certbot, renewal, and an in-machine TLS reverse proxy |
